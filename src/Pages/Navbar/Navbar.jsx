...
const Navbar = () => {
    ...
    const menuItems = <>
        ...
        <li className=''><Link to='/'>Advertised</Link></li>
        ...
        <div className="navbar rounded-b-xl bg-gray-800 text-white flex justify-between  py-4 sm:px-16 px-4">
            <div className="md:navbar-start justify-between">
                <div className="dropdown">
                    ...
                    <ul tabIndex={1} className="menu bg-white text-black menu-compact dropdown-content mt-3 p-2 shadow  rounded-box w-52">
                        {menuItems}
                    </ul>
                </div>
