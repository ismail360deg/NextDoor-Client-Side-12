                ...
                <div className='h-[500px] flex justify-center items-center rounded-2xl bg-gray-800 '>
                    <div className='w-96 p-7'>
                        ...
                        <form onSubmit={handleSubmit(handleLogin)} >
                            ...
                            <input className='btn w-full bg-lime-600' value='Login' type="submit" />
                            <div>
                        ...
                        <div className="flex justify-center space-x-4">
                            <button onClick={handleGoogleSignIn} aria-label="Log in with Google" className="p-3 rounded-sm">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className=" fill-current bg-lime-600 text-gray-50 rounded-full w-8 h-8 sm:w-8 sm:h-8">
